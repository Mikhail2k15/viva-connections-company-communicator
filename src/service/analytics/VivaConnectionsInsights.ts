...
export default class VivaConnectionsInsights {
    ...
    public static async getViewCount(service: AppInsightsAnalyticsService, notificationId: string, timeSpan: TimeSpan){
        ...
        return await service.getQueryResultAsync(uniqueViewCountQuery, timeSpan);
    }
}